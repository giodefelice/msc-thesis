...
Permutational quantum computing is a model of quantum computation introduced by Jordan \cite{Jordan09}. This section was developed in collaboration with Vojtech Havlicek, (\ref{jordansection}) is based on \cite{Havlicek17} and \cite{Jordan09}. We will first introduce the model and then give a categorical presentation not present in the literature which will allow us to generalize the model and compare it to other computational models.

\subsubsection{Jordan's model}\label{jordansection}
