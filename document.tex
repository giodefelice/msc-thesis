...
\appendix
	...
	The following two definitions are generalisations of the notions of injection and surjection from set theory.
	...
	\end{definition}
	It can be shown that the zero morphism of any hom-set is then the unit of the abelian group structure \cite{Vicary12}.
