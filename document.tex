...
\begin{definition}
	...
	\symequation
\end{definition}
One important difference between $Sets$ and $Hilb$ is that $Hilb$ exhibits duality.
\begin{definition}[Rigidity]
	...
	\snake
	\snakestar
	If every object has a dual, we say that $\mathcal{C}$ is rigid.
\end{definition}
...
\end{definition}
Simply flipping all the diagrams we obtain the dual notion of a comonoid.
\begin{definition}
...
\begin{proposition}
	$Rep(H)$ is a monoidal category for any bialgebra $H$.
\end{proposition}
\begin{proof}
