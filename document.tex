...
\end{theorem}
Let us fix a bialgebra $H$ and suppose $ \left( V, \begin{tikzpicture}[scale=0.5, squr/.style={draw,regular polygon,
	regular polygon sides=4,fill=black}]
...
\begin{proof}
	...
	\end{gathered} \,\right)
	\end{equation*} 
	is an intertwiner by associativity. Also it is easy to check that the symmetry morphism lifted from $Vect$ 
	$$
	\left( H, \, \begin{gathered}
	\begin{tikzpicture}[scale=0.5]
	\draw (0,-0.5)--(0,0.5);
