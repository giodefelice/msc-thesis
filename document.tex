...
\subsubsection{From groups to Hopf algebras}
...
\begin{definition}[Bialgebra]
	...
	\cocopylaw
\end{definition}
We are now ready to introduce one of the main topics of this thesis.
...
We are mainly interested in the study of Hopf Algebras (i.e models of $Hopf$ in $Vect$). The first simple but important result is the following.
\begin{proposition}
...
\subsubsection{Representations of Hopf algberas}
...
\begin{proof}
	...
	\begin{equation}
		...
		\node[whit] (1) at (0, 1.3) {};
		\node[black] (2) at (1, 1.3) {};
		\node[scale=0.8,draw,circle, fill=black] (3) at (-1.2, 0.5) {};
	...
	\node[scale=0.8,draw,circle, fill=white] (3) at (-0.7, 0.5) {};
	\node (5) at (1, -0.4) {};
	\node[scale=0.8,draw,circle, fill=black] (6) at (-0.7, 0) {};
	\draw (0) to (1);
	\draw (5) to (2);
	\draw (1) to (0,2);
	\draw (2) to (1,2);
	...
	\node[whit] (1) at (0, 1.3) {};
	\node[black] (2) at (1, 1.3) {};
	\node[scale=0.8,draw,circle, fill=black] (3) at (-0.9, 0.2) {};
	\node (5) at (1, -0.4) {};
	\node[scale=0.8,draw,circle, fill=black] (6) at (-0.3, 0.2) {};
	\draw (0) to (1);
	\draw (5) to (2);
	\draw (1) to (0,2);
	\draw (2) to (1,2);
